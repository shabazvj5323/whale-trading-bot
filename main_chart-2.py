...
class WhaleEngine:
    ...
    def build_dashboard(self):
        ...
        for d in self.dashboard:
            ...
            monitor_rows += (
                "<div class='monitor-card' ontouchend=\"this._t=1\" ontouchstart=\"this._t=0\" onclick=\"if(!this._t){window.open('" + okx_url + "','_blank');}\">"
...
"""
        ...
        html = (
            ...
            # Tabs
            "function showTab(i){document.querySelectorAll('.panel').forEach(function(p,j){p.classList.toggle('active',i===j);});document.querySelectorAll('.tab').forEach(function(t,j){t.classList.toggle('active',i===j);});}"
            # Chart
