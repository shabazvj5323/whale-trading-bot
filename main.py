...
class WhaleEngine:
    ...
    def score_signal(self, opens, highs, lows, closes, vols, closes15):
        ...
        # Adaptive MIN_SCORE based on volatility
        if atr_pct > 1.5:
            adaptive_min = 5   # High volatility = more opportunities
        elif atr_pct < 0.5:
            adaptive_min = 7   # Low volatility = strict filter
        else:
            adaptive_min = 6   # Normal market
        ...
        if direction:
            if regime == "BULL" and direction == "buy":
                ...
                score += 1   # Sideways = both directions ok, small bonus
