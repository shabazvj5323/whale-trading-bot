# main.py – Fully corrected with auto-history repair
import time
import logging
import os
import json
...
# ── PRICE ACTION & SMC (corrected – opens parameter added) ──
...
class WhaleEngine:
    def __init__(self):
        ...
        # Load history – auto‑repair if corrupted
    ...
    def load_history(self):
        ...
        try:
            ...
            # Rebuild daily_pnl from trades if corrupted or missing
    ...
    # ── SCORING (with corrected PA calls) ──
    ...
    # ── Position management (with trailing) ──
