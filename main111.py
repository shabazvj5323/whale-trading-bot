...
class WhaleEngine:
    ...
    # ── Single scan ──
    def scan_once(self):
        """One full market scan, then exit."""
        log.info("=== Starting single market scan ===")
        self.dashboard = []
        ...
        log.info("Single scan completed. Exiting now.")
...
if __name__ == "__main__":
    engine = WhaleEngine()
    engine.scan_once()   # single scan, then exit